                ...
                <ul class="layui-nav layui-layout-right">
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:void(0)"><i class="layui-icon layui-icon-notice"></i>&nbsp;消息</a></dd>
                ...
                <div class="layui-side-scroll">
                    <ul class="layui-nav layui-nav-tree" lay-filter="">
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd>
                                    <a data-url="${ysdrzp}/application/sys/org/org_tree.jsp" data-id="1111" data-title="机构管理" href="#" class="site-nav-active" data-type="tabAdd"><i class="layui-icon layui-icon-group"></i>&nbsp;&nbsp;&nbsp;机构管理</a>
                                </dd>
                                <dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd>
                                    <a data-url="${ysdrzp}/application/sys/authorization/user_auth_list.jsp" data-id="5555" data-title="用户授权" href="#" class="site-nav-active" data-type="tabAdd"><i class="layui-icon layui-icon-auz"></i>&nbsp;&nbsp;授权管理</a>
                                </dd>
                            </dl>
                        </li>
                        <li class="layui-nav-item">
